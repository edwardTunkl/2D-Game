...
export class Running extends State {
  ...
  handleInput(input) {
    this.game.particles.unshift(
      new Dust(
        this.game,
        this.game.player.x + this.game.player.width * 0.63,
...
export class Jumping extends State {
  ...
  enter() {
    if (this.game.player.onGround()) this.game.player.velY -= 27;
    this.game.player.frameX = 0;
    this.game.player.maxFrame = 6;
    this.game.player.frameY = 1;
  }
  handleInput(input) {
    if (this.game.player.velY > this.game.player.weight) {
